...
class EmailsService {
    public requestSettlement(transactionParty: string, transaction: Transaction, email: string) {
        const html = fs.readFileSync('src/utils/RequestSettlementEmailTemplate.html', {encoding: 'utf-8'});
        ...
        this.sendEmail(noReplyEmailAddress, email, "Settlement Request", template);
    }
